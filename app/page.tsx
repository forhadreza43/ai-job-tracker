...
export default function HomePage() {
  return (
    <>
      <section className="border-b border-border bg-background px-4 py-12 text-center mt-22 container max-w-360 mx-auto">
        ...
        <p className="text-sm text-muted-foreground max-w-xl mx-auto leading-relaxed">
          ...
          details from circulars using AI, and get notified when interview or
          assessment emails arrive in their inbox.
        </p>
